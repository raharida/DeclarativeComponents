...
public class PercentageComponentHandler extends IncludeHandler {

  private static final String _VIEW_ID = "/PercentageComponent.jsf";

  public PercentageComponentHandler(ComponentConfig config) {
    super(config);
  }
